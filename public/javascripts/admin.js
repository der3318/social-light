...
document.addEventListener("DOMContentLoaded", function(){
    ...
    hu.addEventListener("click", function() {
        ...
        viewUsers(document.getElementById("keyword").value.trim());
    });
    hb.addEventListener("click", function() {
        current.className = "item";
        current = hb;
        current.className = "active item";
        viewBoards(document.getElementById("keyword").value.trim());
    });
    hp.addEventListener("click", function() {
        current.className = "item";
        current = hp;
        current.className = "active item";
        viewPosts(document.getElementById("keyword").value.trim());
    });
